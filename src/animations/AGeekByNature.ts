...
// divMotion.addKey(0, new Props().C().O(0).TY(100).S(100).F().get());
// divMotion.setEas(esz.s.EASE_OUT3);
divMotion.addKey(0, new Props().C().O(0).TY().S(0).F().get());
divMotion.addKey(1, new Props().C().O().TY().S(100).F().get());
divMotion.setEas(esz.s.EASE_OUT3);
divMotion.addKey(1111, new Props().C().O().TY(-100).S(100).F().get());
divMotion.holdPrev(700);
divMotion.setEas(esz.s.EASE_OUT3);
divMotion.addKey(1111, new Props().C().O(1).TY().S(100).F().get());
...
a.addKey(key_POSE_IN, new Props().C().O(1).T(   0, 0, 0).F().get());
a.holdPrev(999);
a.setEas(esz.s.EASE_IN_OUT);
a.addKey(333, new Props().C().O(0).T(  0, 0, 0).F().get());


const geek = new Motion(document.querySelector('#geek'),delay+ 550);
geek.addKey(0, new Props().C().O(0).TX(190).F().get());
geek.setEas(esz.s.STEPS1);
geek.addKey(444, new Props().C().O(1).TX(140).F().get());
geek.setEas(esz.s.STEPS1);
geek.addKey(444, new Props().C().O(1).TX(90).F().get());
geek.setEas(esz.s.STEPS1);
geek.addKey(444, new Props().C().O(1).TX(20).F().get());
geek.setEas(esz.s.STEPS1);
geek.addKey(444, new Props().C().O(1).TX(-40).F().get());
geek.setEas(esz.s.STEPS1);
geek.addKey(444, new Props().C().O(1).TX(-90).F().get());
geek.setEas(esz.s.STEPS1);
geek.addKey(444, new Props().C().O(1).TX(-150).F().get());
geek.holdPrev(444)
