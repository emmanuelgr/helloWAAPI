...
divMotion.addKey(0, new Props().O(0).TY('100vh').S(100,100,100).F().get());
divMotion.setEas(esz.s.EASE_OUT3);
divMotion.addKey(1111, new Props().O().TY().S(100,100,100).F().get());
divMotion.setEas(esz.s.EASE_OUT3);
divMotion.addKey(1111, new Props().O().TY('-100vh').S(100,100,100).F().get());
divMotion.holdPrev(700);
divMotion.setEas(esz.s.EASE_OUT3);
divMotion.addKey(1111, new Props().O(1).TY().S(100,100,100).F().get());
...
geek.addKey(0, new Props().O(0).TX('190vmin').F().get());
geek.setEas(esz.s.STEPS1);
geek.addKey(444, new Props().O(1).TX('140vmin').F().get());
geek.setEas(esz.s.STEPS1);
