...
const paps = new Motion(document.querySelector('#iamPapa'), delay+666);
paps.addKey(0, new Props().C().TX().RY(-360).S(0).get());
paps.setEas(esz.s.EASE_OUT4);
paps.addKey(666, new Props().C().TX().RY(0).S().get());
paps.holdPrev(666);
paps.setEas(esz.s.EASE_OUT4);
paps.addKey(1222, new Props().C().TX(-38).RY(-90).S(1).get());
paps.setEas(esz.s.EASE_IN3);
paps.addKey(666, new Props().C().TX().RY(-90).S(0).get());
